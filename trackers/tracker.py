...
class Tracker:
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        self.detections = self.detect_frames(frames)

        tracks = {"players": [], "referees": [], "ball": []}

        for frame_num, detection in enumerate(self.detections):
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        ...
        cv2.putText(
            frame,
            "Team 1 Ball Control: {:.2f}%".format(team_1 * 100),
            (1400, 900),
            cv2.FONT_HERSHEY_SIMPLEX,
            1,
            (0, 0, 0),
        ...
        cv2.putText(
            frame,
            "Team 2 Ball Control: {:.2f}%".format(team_2 * 100),
            (1400, 950),
            cv2.FONT_HERSHEY_SIMPLEX,
            1,
            (0, 0, 0),
